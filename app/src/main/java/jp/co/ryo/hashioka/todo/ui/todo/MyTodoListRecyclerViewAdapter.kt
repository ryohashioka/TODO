...
import jp.co.ryo.hashioka.todo.ui.todo.TodoListFragment.OnListFragmentInteractionListener

import kotlinx.android.synthetic.main.fragment_todolist.view.*

/**
 * [RecyclerView.Adapter] that can display a [TodoContent.TodoItem] and makes a call to the
